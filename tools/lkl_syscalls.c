...
int main() {
	...
	EXPORT_LKL_SYSCALL(alarm)
	EXPORT_LKL_SYSCALL(bdflush)
	...
	EXPORT_LKL_SYSCALL(chmod)
	EXPORT_LKL_SYSCALL(chown)
	...
	EXPORT_LKL_SYSCALL(futimesat)
	EXPORT_LKL_SYSCALL(getcwd)
	EXPORT_LKL_SYSCALL(getdents)
	...
	EXPORT_LKL_SYSCALL(inotify_init)
	...
	EXPORT_LKL_SYSCALL(lchown)
	EXPORT_LKL_SYSCALL(lgetxattr)
	EXPORT_LKL_SYSCALL(link)
	...
	EXPORT_LKL_SYSCALL(mkdir)
	EXPORT_LKL_SYSCALL(mkdirat)
	EXPORT_LKL_SYSCALL(mknod)
	...
	EXPORT_LKL_SYSCALL(unlink)
	EXPORT_LKL_SYSCALL(unlinkat)
	EXPORT_LKL_SYSCALL(unshare)
	EXPORT_LKL_SYSCALL(uselib)
	EXPORT_LKL_SYSCALL(userfaultfd)
	EXPORT_LKL_SYSCALL(ustat)
	EXPORT_LKL_SYSCALL(utime)
	EXPORT_LKL_SYSCALL(utimensat)
	EXPORT_LKL_SYSCALL(utimes)
	EXPORT_LKL_SYSCALL(vfork)
