...
#define str(s) #s
#define EXPORT_LKL_SYSCALL(name) printf("__LKL_SYSCALL(" str(name) ")\n");

#define EXPORT_HOST_SYSCALL(name)                                  \
    printf(                                                        \
        "#define __lkl__NR_" str(name) " __lkl__NR_syscalls+%d\n", \
        __COUNTER__);                                              \
    printf("__LKL_SYSCALL(" str(name) ")\n");

int main()
{
    printf("// Generated using tools/lkl_syscalls.c , changes will be "
           "overwritten\n\n");
