...
static struct sgxlkl_config_elem sgxlkl_config[] = {
 ...
 /* 29 */ {"SGXLKL_MAX_USER_THREADS",         "max_user_threads",         TYPE_UINT, {.def_uint = {DEFAULT_SGXLKL_MAX_USER_THREADS, MAX_SGXLKL_MAX_USER_THREADS}}, 0},
 /* 30 */ {"SGXLKL_MMAP_FILES",               "mmap_files",               TYPE_CHAR, {.def_char = "None"}, 0},
 /* 31 */ {"SGXLKL_NON_PIE",                  "non_pie",                  TYPE_BOOL, {.def_bool = 0}, 0},
 /* 32 */ {"SGXLKL_PRINT_APP_RUNTIME",        "print_app_runtime",        TYPE_BOOL, {.def_bool = 0}, 0},
 /* 33 */ {"SGXLKL_PRINT_HOST_SYSCALL_STATS", "print_host_syscall_stats", TYPE_BOOL, {.def_bool = 0}, 0},
 /* 34 */ {"SGXLKL_REAL_TIME_PRIO",           "real_time_prio",           TYPE_BOOL, {.def_bool = 0}, 0},
 /* 35 */ {"SGXLKL_REMOTE_ATTEST_PORT",       "remote_attest_port",       TYPE_UINT, {.def_uint = {DEFAULT_SGXLKL_REMOTE_ATTEST_PORT, USHRT_MAX}}, 0},
 /* 36 */ {"SGXLKL_REMOTE_CMD_PORT",          "remote_cmd_port",          TYPE_UINT, {.def_uint = {DEFAULT_SGXLKL_REMOTE_CMD_PORT, USHRT_MAX}}, 0},
 /* 37 */ {"SGXLKL_REMOTE_CMD_ETH0",          "remote_cmd_eth0",          TYPE_BOOL, {.def_bool = 0}, 0},
 /* 38 */ {"SGXLKL_REMOTE_CONFIG",            "remote_config",            TYPE_BOOL, {.def_bool = 0}, 0},
 /* 39 */ {"SGXLKL_REPORT_NONCE",             "report_nonce",             TYPE_UINT, {.def_uint = {0, ULONG_MAX}}, 0},
 /* 40 */ {"SGXLKL_SHMEM_FILE",               "shmem_file",               TYPE_CHAR, {.def_char = NULL}, 0},
 /* 41 */ {"SGXLKL_SHMEM_SIZE",               "shmem_size",               TYPE_UINT, {.def_uint = {0, 1024 * 1024 * 1024}}, 0},
 /* 42 */ {"SGXLKL_SIGPIPE",                  "sigpipe",                  TYPE_BOOL, {.def_bool = 0}, 0},
 /* 43 */ {"SGXLKL_SSLEEP",                   "ssleep",                   TYPE_UINT, {.def_uint = {DEFAULT_SGXLKL_SSLEEP, ULONG_MAX}}, 0},
 /* 44 */ {"SGXLKL_SSPINS",                   "sspins",                   TYPE_UINT, {.def_uint = {DEFAULT_SGXLKL_SSPINS, ULONG_MAX}}, 0},
 /* 45 */ {"SGXLKL_STACK_SIZE",               "stack_size",               TYPE_UINT, {.def_uint = {DEFAULT_SGXLKL_STACK_SIZE, ULONG_MAX}}, 0},
 /* 46 */ {"SGXLKL_STHREADS",                 "sthreads",                 TYPE_UINT, {.def_uint = {DEFAULT_SGXLKL_STHREADS, MAX_SGXLKL_STHREADS}}, 0},
 /* 47 */ {"SGXLKL_STHREADS_AFFINITY",        "sthreads_affinity",        TYPE_CHAR, {.def_char = NULL}, 0},
 /* 48 */ {"SGXLKL_SYSCTL",                   "sysctl",                   TYPE_CHAR, {.def_char = NULL}, 0},
 ...
 /* 59 */ {"SGXLKL_WAIT_ON_HOST_CALLS",       "wait_on_host_calls",       TYPE_BOOL, {.def_bool = 0}, 0},
 /* 60 */ {"SGXLKL_WAIT_ON_IO_HOST_CALLS",    "wait_on_io_host_calls",    TYPE_BOOL, {.def_bool = 0}, 0},
 /* 61 */ {"SGXLKL_WG_IP",                    "wg_ip",                    TYPE_CHAR, {.def_char = DEFAULT_SGXLKL_WG_IP}, 0},
