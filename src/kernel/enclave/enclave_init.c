...
static void startmain(void* args)
{
    ...
    // TODO: move the following block (disk mounting/cryptsetup) to user space
    {
    ...
    enter_user_space(sgxlkl_enclave, &app_config, &__libc_state, sgxlkl_verbose);
}
