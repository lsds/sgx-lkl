...
bool
sgxlkl_base64_validate(const unsigned char *src, size_t len)
{
 ...
 * @out: Buffer to use or %NULL if it should be allocated here
 ...
 */
unsigned char *
sgxlkl_base64_encode(const unsigned char *src, size_t len, unsigned char *out, size_t *out_len)
{
    unsigned char *pos;
 ...
 */
unsigned char *
sgxlkl_base64_decode(const unsigned char *src, size_t len, unsigned char *out, size_t *out_len)
{
