...
const sgxlkl_enclave_setting_t sgxlkl_enclave_settings[46] = {
    ...
    {"wg.key", "char*", "Private Wireguard key. Will be ignored in release mode in which a new key pair is generated inside the enclave on startup.", "None", "SGXLKL_WG_KEY"},
    ...
    {"sysctl", "char*", "'sysctl' configurations. Semicolon-separated list of key value pairs in the form 'key1=value1;key2=value2;[...]'.", "None", "SGXLKL_SYSCTL"},
    {"swiotlb", "bool", "Enable DMA bounce buffer support, even in sw mode.", "true", "SGXLKL_ENABLE_SWIOTLB"},
    {"run", "char*", "Path to the application.", "None", "SGXLKL_CMDLINE"},
