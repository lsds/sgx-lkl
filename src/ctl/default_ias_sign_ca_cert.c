/* Generated from Intel-provided PEM certificate file as follows:
 *  openssl x509 -outform der -in AttestationReportSigningCACert.pem -out AttestationReportSigningCACert.der
 *  xxd -g 1 -i AttestationReportSigningCACert.der
 */
unsigned char default_ias_sign_ca_cert_der[] = {
...
unsigned int default_ias_sign_ca_cert_der_len = 1359;
