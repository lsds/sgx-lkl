...
#ifndef _SGXLKL_HOST_DEBUG_INCLUDE
#define _SGXLKL_HOST_DEBUG_INCLUDE

#include <stdio.h>
#include <stdarg.h>

static const char* const _syscall_names[] = {
    "read", /* 0 */
    "write", /* 1 */
    "open", /* 2 */
    "close", /* 3 */
...
static inline void log_host_syscall(long n, long res, long arg1, long arg2, long arg3, long arg4, long arg5, long arg6)
{
    char errmsg[255] = {0};
    ...
    printf("[ HOST SYSCALL ] [tid=???] %s\t%ld\t(%ld, %ld, %ld, %ld, %ld, %ld) = %ld%s\n", name, n,
            arg1, arg2, arg3, arg4, arg5, arg6, res, errmsg);
}

#endif /* _SGXLKL_HOST_DEBUG_INCLUDE */
